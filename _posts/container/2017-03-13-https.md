...
首先将服务器中`start.ini`中`etc/jetty-ssl.xml`前面的注释去掉，然后修改jetty目录下的etc/jetty-ssl.xml的KeyStore路径及其密码即可。
...
改为：
```
<Set name="KeyStorePath"><Property name="jetty.base" default="." />/<Property name="jetty.keystore" default="D:/keys/server.keystore"/></Set>

  <Set name="KeyStorePassword">123456</Set>

  <Set name="KeyManagerPassword">123456</Set>

  <Set name="TrustStorePath"><Property name="jetty.base" default="." />/<Property name="jetty.truststore" default="D:/keys/server.keystore"/></Set>
...
`通过httpClient POST or GET 请求httpsUrl`
...
public class HttpsUtil {
	...
	public static void main(String[] args) throws Exception {
		// ****************测试1*******************
		// String httpsURL = "https://www.google.com.hk";
		// simpleTest(httpsURL);
		// ****************测试2*******************
		// String urlStr = "https://www.12306.cn/";
		// String trustStor = "D:/crt_12306";
		// certTest1(urlStr, trustStor);

		// ****************测试3*******************
		// String urlStr1 = "https://127.0.0.1:8443/v1/admin/version";
		// String dir1 =
		// "D:\\openworkspace\\shp\\programs\\shp1.9\\etc\\jettyserver.keystore";
		// String passwd1 = "123456";
		// certTest2(dir1, passwd1, urlStr1);
		//
		// String urlStr2 = "https://127.0.0.1:8443/v1/admin/version";
		// String dir2 =
		// "D:\\openworkspace\\shp\\programs\\shp1.9\\etc\\jettyserver.keystore";
		// String passwd2 = "123456";
		// certTest2(dir2, passwd2, urlStr2);

		// ****************测试4*******************
		// String urlStr3 = "https://127.0.0.1:9443/sqlagent/v1/admin/version";
		// withoutCert(urlStr3);
		// String urlStr4 =
		// "https://127.0.0.1:9443/sqlagent/v1/admin/updates?type=2&versionCode=shp1.3";
		// withoutCert(urlStr4);
		// String urlStr4 =
		// "https://127.0.0.1:9443/sqlagent/v1/admin/config/sys?key=1";
		// withoutCert(urlStr4);

		String urlStr5 = "https://127.0.0.1:9443/sqlagent/v1/admin/config/sys";
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("key", "123123"));
		SendHttpsPOST(urlStr5, params);
	}
	...
	public static TrustManager[] getTms(String dir, String keyPassword) throws Exception {
	...
	public static void certTest2(String certDir, String passwd, String urlStr) throws Exception {
		...
		InputStreamReader im = new InputStreamReader(conn.getInputStream(), "UTF-8");
	...
	public static String withoutCert(String urlStr) throws Exception {
	...
	public static String SendHttpsPOST(String url, List<? extends NameValuePair> param) {
		String result = null;
